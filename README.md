...
- [Установка Zabbix server и agent v7.4 для Ubuntu 22.04](files/004_install_zabbix_v_7_4/playbook.yml) или использовать [bash-скрипт установки Zabbix server v7.4](files/004_install_zabbix_v_7_4/install_zabbix_serv.sh)
